...
public class utils extends base {
    ...
    public static int isElementVisible(By by) {
    ...
    public static void UploadFile(By by, By args) {
        ...
        File file = new File("C:\\QA_Resources\\Automation Projects\\AutomationScripts\\Selenium+Java\\MRIEnergy_AutomationSuite\\src\\test\\resources\\attachments\\mri_energy_logo.png");
    ...
    public static void moveFile(Path oldFilePath, Path newFilePath) {
        try {
            ...
            for (Path filePath : directoryStream) {
                ...
                System.out.println("Moved: " + filePath.getFileName() + " to " + targetPath);
...
//            File oldFolder = new File(System.getProperty("user.dir") + "/MRITestExecutionReports/" + loadProps.getProperty("Version"));
//            File newFolder = new File(System.getProperty("user.dir") + "/MRITestExecutionReports/" + path);
//            if (!oldFolder.equals(newFolder)) {
//                utils.moveFile(oldFolder.toPath(), newFolder.toPath());
//            }
//            if (!oldFolder.equals(newFolder)&&isDelete) {
...
//            }
    ...
    public static void zipFolder(Path source) throws IOException {
        ...
        try (
                ZipOutputStream zos = new ZipOutputStream(
                        Files.newOutputStream(Paths.get(System.getProperty("user.dir") + "/MRITestExecutionReports/" + zipFileName)))
        ) {
    ...
    public String getScreenShotPath(String TestName) throws IOException, AWTException {
        ...
        String destPath = System.getProperty("user.dir") + "/MRITestExecutionReports/" + loadProps.getProperty("Version") + "/" + "screenShots/" + TestName +"_"+ utils.timeStamp() + ".png";
