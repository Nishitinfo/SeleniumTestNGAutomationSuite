...
public class myRecording extends ScreenRecorder {
    ...
    public static void startRecording() throws Exception {
        File file = new File(".//MRITestExecutionReports/" + loadProps.getProperty("Version").replaceAll("[()-+.^:, ]", "") + "/recordings/");
        ...
        screenRecorder = new myRecording(gc, captureSize,
    ...
    protected File createMovieFile(Format fileFormat) throws IOException {
        ...
        return new File(movieFolder,
                "recoding" + "_" + dateFormat.format(new Date()) + "." + Registry.getInstance().getExtension(fileFormat));
