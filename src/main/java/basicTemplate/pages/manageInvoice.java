...
public class manageInvoice extends utils {
    ...
    public static String Month = loadProps.getProperty("InvoiceDMonth");
    public static String Path = loadProps.getProperty("Path");
    public static String Portfolio = loadProps.getProperty("Portfolio");
    public static By headerSection = By.xpath("//*[@id=\"MainPane\"]/div/h3");
    public static By invoiceValidationMenu = By.xpath("//*[@id=\"MainMenu\"]/li[6]/a/div/span");
    public static By manageInvoiceLink = By.xpath("/html/body/form/div[5]/div[1]/div[3]/div[1]/ul/li[6]/div/ul/li[9]/a");
    ...
    public static By selectPortfolio = By.xpath("//span[normalize-space()='" + Portfolio + "']");
    ...
    public static By SelectInvoiceDateByPath = By.xpath("//div/div/div/div[2]/table/tbody/tr[1]/td[2]/span");
    ...
    public static By selectReceivedDateByPath = By.xpath("//div/div/div/div[2]/table/tbody/tr[1]/td[2]/span");
    ...
    public static By SelectByDefault = By.xpath("/html/body/div[7]/div/div/div/div[2]/ul/li[1]/span[1]");
    public static By saveMeterData = By.xpath("//div[2]/div[2]/div[1]/div/table/tbody/tr[1]/td[8]/span/button[3]");
    public static By clickOnRemoveMeter = By.xpath("//div[2]/div[2]/div[1]/div/table/tbody/tr[1]/td[8]/span/button[2]");
    ...
    public static By SelectPath = By.xpath("//*[normalize-space(text())='" + Path + "']/parent::*");
    public static By clickOnStartDateCalenderOnListing = By.xpath("/html/body/div[1]/div[2]/div/div/div[1]/div[6]/div/span[1]/button");
    ...
    public void redirectToInvoiceList() throws InterruptedException {
        ...
        Thread.sleep(2000);
        List<WebElement> elements = driver.findElements(manageInvoiceLink);
    ...
    public void createInvoice() throws InterruptedException {
        List<WebElement> elements = driver.findElements(headerSection);
        int count = elements.size();
        if (count < 1) {
    ...
    public void invoiceConsumption() throws InterruptedException {
        ...
        Thread.sleep(1000);
        List<WebElement> elements = driver.findElements(By.xpath(".k-button-solid.k-rounded-full.k-button-md.k-button-solid-base.k-icon-button"));
        int consumptionMeter = elements.size();
...
//        clickOnElement(selectMeterNumber);
    ...
    public void deleteInvoice() throws InterruptedException {
        List<WebElement> header = driver.findElements(headerSection);
        ...
        if (isElementPresent(selectRawInGrid)) {
            ...
            Thread.sleep(1500);
            List<WebElement> elements = driver.findElements(selectDeleteOption);
            if (!elements.isEmpty()) {
            ...
            System.out.println("Invoice is locked.");
        }
    }
