...
import basicTemplate.pages.manageInvoice;
import io.cucumber.java.en.And;
import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;
import org.testng.Assert;

public class manageInvoices extends browserSelector {

    public static manageInvoice Invoice = new manageInvoice();
    ...
    public void verify_That_User_Should_Be_Able_To_Access_The_Invoice_Validation() {
        ...
        String expectedLink = "https://uksestdevtest02.ukest.lan/MRIEnergy/AdvancedWeb/invoices";
